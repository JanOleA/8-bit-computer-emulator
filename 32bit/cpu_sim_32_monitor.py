...
class Computer_32(Computer):
    ...
    def __init__(self, progload, bits = 8,
        ...
        if bits > 16:
            ...
            self.memory = np.zeros(2**bits, dtype = np.uint16)
...
class Game_32(Game):
    ...
    def setup_fonts(self):
        ...
        self._font_console_bold = pygame.font.SysFont("Hack", 17, bold = True)
        self._font_small_console = pygame.font.SysFont("Hack", 11)
        self._font_small_console_bold = pygame.font.SysFont("Hack", 11, bold = True, italic = True)
        self._font_small_console_bold2 = pygame.font.SysFont("Hack", 12, bold = True)
        self._font_verysmall_console = pygame.font.SysFont("Hack", 10)
        self._font_verysmall_console_bold = pygame.font.SysFont("Hack", 10, bold = True)
        self._font_veryverysmall_console = pygame.font.SysFont("Hack", 9)
        self._font_veryverysmall_console_bold = pygame.font.SysFont("Hack", 9, bold = True)
